      ...
      <div className="withdraw-view">
        ...
        <div className="withdraw-cash-step">
          <div className="withdraw-cash-step-one">
            <div className="withdraw-cash-step-text1">第一步</div>
            <div className="withdraw-cash-step-text2">下载打开银魔方APP</div>
            <img src={img1} className="withdraw-cash-step-img" />
          </div>
          <div className="withdraw-cash-step-two">
            <div className="withdraw-cash-step-text1">第二步</div>
            <div className="withdraw-cash-step-text2">在“我的”中提现</div>
